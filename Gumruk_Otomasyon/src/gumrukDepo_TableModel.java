...
public class gumrukDepo_TableModel
{
   ...
   private int satirSayisi; 
  	...
  	Object kolonlar[] = {"Şoför Numara", "Şoför Plaka", "Şoför Ad", "Tır Marka", "Tır Model", "Yükün Türü", "Yükün Ağırlığı", "Giriş Tarihi", "Kayıt Eden"}; 
   
  	public gumrukDepo_TableModel(ResultSet resultSet) throws Exception
        { 
